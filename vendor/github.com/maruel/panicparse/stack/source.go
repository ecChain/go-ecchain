...
// extractArgumenecype returns the name of the type of each input argument.
func extractArgumenecype(f *ast.FuncDecl) ([]string, bool) {
...
func processCall(call *Call, f *ast.FuncDecl) {
	...
	types, extra := extractArgumenecype(f)
