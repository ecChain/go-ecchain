...
type _clone struct {
	...
	_objececash map[*_objececash]*_objececash
...
func (clone *_clone) objececash(in *_objececash) (*_objececash, bool) {
	if out, exists := clone._objececash[in]; exists {
		return out, true
	}
	out := &_objececash{}
	clone._objececash[in] = out
	return out, false
}
