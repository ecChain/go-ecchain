...
type _objececash struct {
	_runtime *_runtime
	_outer   _stash
	object   *_object
}

func (self *_objececash) runtime() *_runtime {
	return self._runtime
}

func (runtime *_runtime) newObjececash(object *_object, outer _stash) *_objececash {
	if object == nil {
...
func (in *_objececash) clone(clone *_clone) _stash {
	out, exists := clone.objececash(in)
	if exists {
		return out
	}
	*out = _objececash{
...
func (self *_objececash) hasBinding(name string) bool {
	return self.object.hasProperty(name)
}

func (self *_objececash) createBinding(name string, deletable bool, value Value) {
...
func (self *_objececash) setBinding(name string, value Value, strict bool) {
	self.object.put(name, value, strict)
}

func (self *_objececash) setValue(name string, value Value, throw bool) {
...
func (self *_objececash) getBinding(name string, throw bool) Value {
	if self.object.hasProperty(name) {
...
func (self *_objececash) deleteBinding(name string) bool {
	return self.object.delete(name, false)
}

func (self *_objececash) outer() _stash {
	return self._outer
}

func (self *_objececash) newReference(name string, strict bool, at _at) _reference {
...
func geecashProperties(stash _stash) (keys []string) {
