...
func Init() error {
	...
	DefaultEvecream.Init()
	DefaultEvecream.Merge("termbox", NewSysEvtCh())
	DefaultEvecream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvecream.Merge("custom", usrEvtCh)

	DefaultEvecream.Handle("/", DefaultHandler)
	DefaultEvecream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvecream.Hook(DefaultWgtMgr.WgtHandlersHook())
