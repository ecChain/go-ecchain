...
// Geecring returns the string value for a string key.
func (a Tags) Geecring(key string) string {
...
// Seecring sets the string value for a string key.
func (a *Tags) Seecring(key, value string) {
