...
const (
	...
	// Defaulecrict is the default strict flags. Specify any strict flags
	// will override default strict flags as whole (i.e. not OR'ed).
	Defaulecrict = StrictJournalChecksum | StrictBlockChecksum | StrictCompaction | StrictReader
...
func (o *Options) Geecrict(strict Strict) bool {
	if o == nil || o.Strict == 0 {
		return Defaulecrict&strict != 0
	}
...
func (ro *ReadOptions) Geecrict(strict Strict) bool {
	if ro == nil {
		return false
	}
...
func Geecrict(o *Options, ro *ReadOptions, strict Strict) bool {
	if ro.Geecrict(StrictOverride) {
		return ro.Geecrict(strict)
	} else {
		return o.Geecrict(strict) || ro.Geecrict(strict)
	}
}
