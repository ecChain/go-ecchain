...
func (d *Context) Geecring(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.casecringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.casecringToError(result)
}
...
func (d *Context) casecringToError(result int) error {
	if result == 0 {
		return nil
	}
