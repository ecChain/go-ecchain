...
/*
bzz implements the swarm wire protocol [bzz] (sister of ec and shh)
...
* talks the SWAP payment protocol (swap accounting is done within Neecore)
*/
...
import (
	...
	bzzswap "github.com/ecchain/go-ecchain/swarm/services/swap"
...
func (self *bzz) handle() error {
	...
	case storeRequestMsg:
		// store requests are dispatched to neecore
	...
	case retrieveRequestMsg:
		// retrieve Requests are dispatched to neecore
		...
		if req.isLookup() {
			...
			// swap accounting is done within neecore
