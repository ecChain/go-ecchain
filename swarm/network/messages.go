...
import (
	...
	"github.com/ecchain/go-ecchain/swarm/network/kademlia"
	"github.com/ecchain/go-ecchain/swarm/services/swap"
...
to be used to booecrap kademlia tables.
...
Timeout serves to indicate whecer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whecer responder is expected to deliver content
