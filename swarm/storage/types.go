...
import (
	...
	"github.com/ecchain/go-ecchain/bmt"
...
func newRequesecatus(key Key) *Requesecatus {
	return &Requesecatus{
		Key:        key,
...
- Neecore: cloud storage abstraction layer
