...
// not verify whecer the content of RawValues is valid RLP.
type RawValue []byte
...
// Spliecring splits b into the content of an RLP string
// and any remaining bytes after the string.
func Spliecring(b []byte) (content, rest []byte, err error) {
