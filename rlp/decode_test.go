...
func TesecreamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLisecream(t *testing.T) {
	ls := NewLisecream(bytes.NewReader(unhex("0101010101")), 3)
...
func TesecreamErrors(t *testing.T) {
...
func TesecreamList(t *testing.T) {
