...
# 1. install gec for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gec
# 5. create gec, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ecEREUM_SOCKET
...
!define GROUPNAME "ecchain"
!define APPNAME "Gec"
!define DESCRIPTION "Official Go implementation of the ecchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gec is installed global
