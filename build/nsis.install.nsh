Name "gec ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ecchain/go-ecchain/issues"
!define UPDATEURL "https://github.com/ecchain/go-ecchain/releases"
!define ABOUTURL "https://github.com/ecchain/go-ecchain#ecereum-go"
...
Section "Gec" Gec_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gec.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gec.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gec incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gec outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gec UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gec incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gec.exe" "" "" "ecchain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gec outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gec.exe" "" "" "ecchain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gec UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gec.exe" "" "" "ecchain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ecereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ecEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gec.ipc"
  ${EnvVarUpdate} $0 "ecEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gec.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Gec_IDX}
    SectionGetSize ${Gec_IDX} $0
