...
// See https://github.com/ecereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whecer the event notification loop is running
...
// HasAddress reports whecer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given ecchain presale wallet and stores
