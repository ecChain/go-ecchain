...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/ecereum/pyecsaletool

		pyecsaletool generates the encryption key from password by
	...
	*/
	...
	ecPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(ecPriv)
	...
	expectedAddr := preSaleKeyStruct.ecAddr
