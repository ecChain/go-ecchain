...
// Status implements accounts.Wallet, returning whecer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain ecereum.ChainStateReader) {}
