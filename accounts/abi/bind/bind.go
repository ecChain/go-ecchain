...
// Package bind generates ecchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-ecereum Wiki page:
// https://github.com/ecchain/go-ecchain/wiki/Native-DApps:-Go-bindings-to-ecchain-contracts
package bind
...
// structured checks whecer a list of ABI data types has enough information to
