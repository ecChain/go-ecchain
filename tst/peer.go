...
// PeerInfo represents a short summary of the ecchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // ecchain protocol version negotiated
...
// Handshake executes the ec protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("ec/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the ecchain sub-protocol.
type peerSet struct {
