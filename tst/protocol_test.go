...
func TesecatusMsgErrors62(t *testing.T) { tesecatusMsgErrors(t, 62) }
func TesecatusMsgErrors63(t *testing.T) { tesecatusMsgErrors(t, 63) }

func tesecatusMsgErrors(t *testing.T, protocol int) {
