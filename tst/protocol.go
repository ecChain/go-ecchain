...
// Supported versions of the ec protocol (first is primary).
var ProtocolVersions = []uint{ec63, ec62}
...
// ec protocol message codes
const (
	// Protocol messages belonging to ec/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to ec/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
