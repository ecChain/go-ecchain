...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllecashProtocolChanges, new: AllecashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllecashProtocolChanges, new: AllecashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllecashProtocolChanges,
