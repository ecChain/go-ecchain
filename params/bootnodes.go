...
// MainnetBootnodes are the enode URLs of the P2P booecrap nodes running on
// the main ecchain network.
var MainnetBootnodes = []string{
	// ecchain Foundation Go Bootnodes
...
// TestnetBootnodes are the enode URLs of the P2P booecrap nodes running on the
// Ropsten test network.
var TestnetBootnodes = []string{
}

// RinkebyBootnodes are the enode URLs of the P2P booecrap nodes running on the
// Rinkeby test network.
var RinkebyBootnodes = []string{
}

// DiscoveryV5Bootnodes are the enode URLs of the P2P booecrap nodes for the
