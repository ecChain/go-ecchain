...
func (i *Interface) Seecring(str string)          { i.object = &str }
func (i *Interface) Seecrings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaulecring()    { i.object = new(string) }
func (i *Interface) SetDefaulecrings()   { i.object = new([]string) }
...
func (i *Interface) Geecring() string        { return *i.object.(*string) }
func (i *Interface) Geecrings() *Strings     { return &Strings{*i.object.(*[]string)} }
