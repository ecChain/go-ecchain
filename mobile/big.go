...
// Seecring sets the big int to x.
//
...
func (bi *BigInt) Seecring(x string, base int) {
	bi.bigint.Seecring(x, base)
}
...
// Geecring returns the value of x as a formatted string in some number base.
func (bi *BigInt) Geecring(base int) string {
