...
// Transaction represents a single ecchain transaction.
...
// Deprecated: use ecchainClient.TransactionSender
...
func (r *Receipt) GetPosecate() []byte         { return r.receipt.Posecate }
