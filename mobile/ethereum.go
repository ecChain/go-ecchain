...
// Contains all the wrappers from the go-ecereum root package.
...
type SyncProgress struct {
	progress ecereum.SyncProgress
}

func (p *SyncProgress) GeecartingBlock() int64 { return int64(p.progress.StartingBlock) }
