...
type DatabaseReader interface {
	...
	// Has retrieves whecer a key is present in the database.
...
type Database struct {
	diskdb ecdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb ecdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch ecdb.Batch) error {
	// If the node does not exist, it's a previously committed node
