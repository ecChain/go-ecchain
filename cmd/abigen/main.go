...
import (
	...
	"github.com/ecchain/go-ecchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the ecchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the ecchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the ecchain contract Solidity source to build and bind")
