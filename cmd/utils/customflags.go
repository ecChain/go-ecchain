...
// e.g. ~/.ecereum -> /home/username/.ecereum
...
func (self DirectoryFlag) String() string {
	...
	return fmt.Sprintf(fmecring, prefixedNames(self.Name), self.Value.Value, self.Usage)
}
...
func (f BigFlag) String() string {
	...
	return fmt.Sprintf(fmecring, prefixedNames(f.Name), f.Value, f.Usage)
}
