...
// This is a simple Whisper node. It could be used as a stand-alone booecrap node.
...
import (
	...
	"github.com/ecchain/go-ecchain/whisper/mailserver"
	whisper "github.com/ecchain/go-ecchain/whisper/whisperv6"
...
// cmd arguments
var (
	booecrapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the booecrap server")
	...
	argEnode   = flag.String("boot", "", "booecrap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *booecrapMode {
		configureNode()
		fmt.Println("Booecrap Whisper node started")
	} else {
