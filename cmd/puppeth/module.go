...
// returned from docker inspect, parsed into a form easily usable by puppec.
type containerInfos struct {
	running bool              // Flag whecer the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whecer there's a container running for the service
	...
	// Infos retrieved, parse the above into somecing meaningful
