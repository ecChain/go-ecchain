...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. ecash - proof-of-work")
	...
	case choice == "1":
		...
		genesis.Config.ecash = new(params.ecashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whecer to modify or export the genesis
	fmt.Println()
	...
	case choice == "2":
		...
		if err := ioutil.WriteFile(w.readDefaulecring(fmt.Sprintf("%s.json", w.network)), out, 0644); err != nil {
