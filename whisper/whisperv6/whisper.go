...
// Whisper represents a dark communication interface through the ecchain
...
// New creates a Whisper client ready to communicate through the ecchain P2P network.
...
// param isP2P indicates whecer the message is peer-to-peer (should not be forwarded).
