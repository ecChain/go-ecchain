...
func (h *Hash) Seecring(s string) { h.SetBytes([]byte(s)) }
...
// Address represents the 20 byte address of an ecchain account.
...
// IsHexAddress verifies whecer a string can represent a valid hex-encoded
// ecchain address or not.
...
func (a *Address) Seecring(s string) { a.SetBytes([]byte(s)) }
