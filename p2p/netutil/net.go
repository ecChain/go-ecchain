...
// Contains reports whecer the given IP is contained in the list.
...
// IsLAN reports whecer an IP is a local network address.
...
// IsSpecialNetwork reports whecer an IP is located in a special-use network range
...
// CheckRelayIP reports whecer an IP relayed from the given sender IP
...
// SameNet reports whecer two IP addresses have an equal prefix of the given bit length.
...
// Contains whecer the given IP is contained in the set.
