...
// isInitDone returns whecer the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the booecrapping
		// logic.
		<-tab.refresh()
...
// booecrap or discarded faulty peers).
