...
// makeTesecate create a sample test state to test node-wise reconstruction.
func makeTesecate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db ecdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ecdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ecdb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTesecate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := ecdb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ecdb.Database), srcRoot)
