...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb ecdb.Putter) error
}
...
func NewDatabase(db ecdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb ecdb.Putter) error {
