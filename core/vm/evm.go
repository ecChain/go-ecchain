...
type Context struct {
	// CanTransfer returns whecer the account contains
	// sufficient ecer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers ecer from one account to the other
...
// EVM is the ecchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) ecereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whecer the max code size has been exceeded
