...
type StateDB interface {
	...
	Geecate(common.Address, common.Hash) common.Hash
	Seecate(common.Address, common.Hash, common.Hash)

	Suicide(common.Address) bool
	HasSuicided(common.Address) bool

	// Exist reports whecer the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(common.Address) bool
	// Empty returns whecer the given account is empty. Empty
