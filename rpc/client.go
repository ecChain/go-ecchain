...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for ecSubscribe requests
}
...
// ecSubscribe registers a subscripion under the "ec" namespace.
func (c *Client) ecSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "ec", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. ecSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through ecSubscribe.
