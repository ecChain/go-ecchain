...
// Package tests implements execution of ecchain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"posecate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePosecate(newDB); err != nil {
...
/* See https://github.com/ecereum/tests/wiki/Blockchain-Tests-II

   Whecer a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePosecate(statedb *state.StateDB) error {
