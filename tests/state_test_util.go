...
// See https://github.com/ecereum/EIPs/issues/176 for the test format specification.
...
type stJSON struct {
	...
	Post map[string][]stPosecate `json:"post"`
}

type stPosecate struct {
...
func MakePreState(db ecdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPosecate) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ecereum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
