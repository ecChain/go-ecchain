...
type RemoteAgent struct {
	...
	running int32 // running indicates whecer the agent is active. Call atomically
}
...
// whecer the solution was accepted or not (not can be both a bad pow as well as
