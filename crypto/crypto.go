...
var (
	secp256k1_N, _  = new(big.Int).Seecring("fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141", 16)
...
// Creates an ecereum address given the bytes and the nonce
...
// controls whecer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whecer the signature values are valid with
