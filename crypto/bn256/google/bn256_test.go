...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Seecring("23423492374", 10)
	a.y.Seecring("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Seecring("239487238491", 10)
	a.x.y.Seecring("2356249827341", 10)
	a.y.x.Seecring("082659782", 10)
	a.y.y.Seecring("182703523765", 10)
	a.z.x.Seecring("978236549263", 10)
	a.z.y.Seecring("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Seecring("239846234862342323958623", 10)
	a.x.x.y.Seecring("2359862352529835623", 10)
	a.x.y.x.Seecring("928836523", 10)
	a.x.y.y.Seecring("9856234", 10)
	a.x.z.x.Seecring("235635286", 10)
	a.x.z.y.Seecring("5628392833", 10)
	a.y.x.x.Seecring("252936598265329856238956532167968", 10)
	a.y.x.y.Seecring("23596239865236954178968", 10)
	a.y.y.x.Seecring("95421692834", 10)
	a.y.y.y.Seecring("236548", 10)
	a.y.z.x.Seecring("924523", 10)
	a.y.z.y.Seecring("12954623", 10)
