...
func makeHeaderChain(parent *types.Header, n int, db ecdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (ecdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() ecdb.Database {
	return odr.db
}
