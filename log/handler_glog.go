...
type GlogHandler struct {
	...
	override  uint32 // Flag whecer overrides are used, atomically accessible
	backtrace uint32 // Flag whecer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whecer this is the callsite
