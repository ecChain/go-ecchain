...
type downloadTester struct {
	...
	stateDb ecdb.Database // Database used by the tester for syncing from peers
	peerDb  ecdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = ecdb.NewMemDatabase()
