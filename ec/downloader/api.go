...
// Syncing provides information when this nodes starts synchronising with the ecchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ecereum.SyncProgress `json:"status"`
}
