...
import (
	...
	"github.com/ecchain/go-ecchain/tests"
)

// To generate a new callTracer test, copy paste the makeTest method below into
// a Gec console and call it with a transaction hash you which to export.
...
var makeTest = function(tx, rewind) {
  ...
  var block   = ec.getBlock(ec.getTransaction(tx).blockHash);
  var genesis = ec.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.ec.config;
