...
// DefaultConfig contains default settings for use on the ecchain main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.ecash.DatasetDir = filepath.Join(home, "AppData", "ecash")
	} else {
		DefaultConfig.ecash.DatasetDir = filepath.Join(home, ".ethash")
	}
}
...
type Config struct {
	...
	// If nil, the ecchain main net block is used.
	...
	ecerbase    common.Address `toml:",omitempty"`
